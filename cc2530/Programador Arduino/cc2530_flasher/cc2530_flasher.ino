...
//            Serial.println("Flash verification error!");
//            while(1);
//        }
//    }
//    Serial.println("Flashado com Sucesso!");
//
//
//   
=======
...
void setup()
{
  ...
  while (!Serial) {
    ...
    *****************************************/
    ...
    chipid = read_xdata_memory(DUP_CHIPID);    
    chver = read_xdata_memory(DUP_CHVER);
    chipinfo0 = read_xdata_memory(DUP_CHIPINFO0);
    chipinfo1 = read_xdata_memory(DUP_CHIPINFO1);
    ...
    Serial.println(chver, HEX);
    Serial.print("Flash Memory Size: ");
    switch((chipinfo0 >> 4) & 0x05){
      case 1:
         Serial.println("32 kB");
      case 2:
         Serial.println("64 kB");
      case 3:
         Serial.println("128 kB");
      case 4:
         Serial.println("256 kB");
    }
    Serial.print("SRAM Memory Size: ");
    Serial.print((chipinfo1 & 0x07) + 1);
    Serial.println("kB");
...
>>>>>>> branch 'master' of https://github.com/vitorqa/ConcretID-HW.git
}
